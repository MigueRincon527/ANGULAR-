  ...
  productos: ProductoProteina[] = [
    {
      ...
      imagen: 'https://via.placeholder.com/300x300?text=Whey+Gold',
      rating: 4.8,
    ...
    },
    {
      ...
      precio: 95000,
      imagen: 'https://via.placeholder.com/300x300?text=Whey+Concentrada',
      rating: 4.5,
    ...
    },
    {
      ...
      tipo: 'Caseína',
      precio: 135000,
      imagen: 'https://via.placeholder.com/300x300?text=Caseina',
      rating: 4.6,
    ...
    },
    {
      ...
      imagen: 'https://via.placeholder.com/300x300?text=Proteina+Vegana',
      rating: 4.3,
    ...
    },
    {
      ...
      tipo: 'Whey Aislada',
      precio: 210000,
      imagen: 'https://via.placeholder.com/300x300?text=Whey+Isolate',
      rating: 4.9,
    ...
    },
    {
      ...
      tipo: 'Whey Concentrada',
      precio: 165000,
      imagen: 'https://via.placeholder.com/300x300?text=Whey+2kg',
      rating: 4.4,
